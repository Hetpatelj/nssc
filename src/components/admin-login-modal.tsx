...
export function AdminLoginModal() {
  ...
  useEffect(() => {
    // Pre-fill email and password for the test admin user for convenience
    setEmail('nssc13@gmail.com');
    setPassword('nssc90');
  }, []);
  ...
  const handleLogin = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // --- Temporary Dev Mode ---
    // This allows access without a real Firebase user, for development purposes.
    if (email === 'nssc13@gmail.com' && password === 'nssc90') {
        toast({
      ...
      <div className="p-6">
        <div className="grid grid-cols-3 gap-4">
          <div className="col-span-1 text-sm text-gray-600">
            <p>Welcome to the admin area. Please login to continue.</p>
