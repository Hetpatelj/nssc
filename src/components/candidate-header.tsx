...
export function CandidateHeader() {
  ...
  const handleUnlockProfile = async () => {
      ...
      toast({
          ...
          description: "Unlocking profiles is not yet supported."
      })
  }
              ...
              <div className="flex items-center justify-between h-16">
                  ...
                  <nav className="flex items-center space-x-1">
                    ...
                    <NavItem label="Application Form">
                      {isProfileLocked ? (
                        <>
                          <DropdownMenuItem onSelect={() => router.push('/candidate/apply')}>Apply For Admission</DropdownMenuItem>
                          <DropdownMenuItem onSelect={handleUnlockProfile}>Unlock Profile</DropdownMenuItem>
