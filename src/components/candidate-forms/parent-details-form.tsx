...
export function ParentDetailsForm({ userData, onNext, onBack }: ParentDetailsFormProps) {
  const { control, handleSubmit, reset, formState: { errors } } = useForm<ParentDetailsFormValues>({
