...
export default function StaffPage() {
  ...
  const staffQuery = useMemo(
    () => (firestore ? query(collection(firestore, 'users'), where('role', '==', 'staff')) : null),
    [firestore]
  );
  const { data: staff, loading } = useCollection<User>(staffQuery);
  ...
  return (
    ...
    <CreateUserModal isOpen={isCreateModalOpen} onClose={() => setIsCreateModalOpen(false)} defaultRole='staff' />
    </>
  );
}
